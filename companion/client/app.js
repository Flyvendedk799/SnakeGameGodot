...
// Smooth interpolation and threat tier visuals
...
function resetMinimapState() {
  ...
  prevMinimapData = { enemies: [], allies: [], players: [], chopper: null };
  minimapLerpT = 1.0;
  lastMinimapSeq = 0;
...
function applyMinimapFull(message) {
  ...
  prevMinimapData = { enemies: [...minimapData.enemies], allies: [...minimapData.allies], players: [...minimapData.players], chopper: minimapData.chopper };
  minimapLerpT = 0;
...
function drawMinimap() {
  ...
  c.fillStyle = comboGlow > 0.03 ? `rgba(${26 + comboLevel * 8}, ${21 + comboLevel * 5}, ${32 + comboLevel * 12}, 1)` : palette.bg;
